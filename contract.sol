...
contract StakingContract is ReentrancyGuard {
    ...
    function viewStakes(address user)public view returns(uint256[] memory){
        return stakerToStakes[user];
    }
    ...
    function getUserStakes(address _user) external view returns (Stake[] memory , uint256[] memory )  {
        ...
        return (userStakes , stakerToStakes[_user]);
    }
